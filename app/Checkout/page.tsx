      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 bg-white overflow-y-auto text-black">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4 mb-4">
              <input
                ...
                className="w-1/2 border-2 border-black-400 rounded-md px-4 py-2 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-500 transition"
              />
              <input
                type="text"
            ...
            <div className="mb-4">
              <input
                type="email"
                placeholder="Email"
                className="w-full border-2 border-black-400 rounded-md px-4 py-2 focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-500 transition"
              />
            </div>
          </div>

          <hr className="border-t border-black-300 my-8" />
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-black-300 rounded px-3 py-2"
              />
          ...
          <div className="mb-8">
            ...
            <select className="w-full border border-black-300 rounded px-3 py-2 mb-4">
